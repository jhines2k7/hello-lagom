...
import com.hines.james.hellolagom.api.GreetingMessage;
import com.hines.james.hellolagom.api.HellolagomService;
import com.hines.james.hellolagom.impl.HellolagomCommand.*;
...
public class HellolagomServiceImpl implements HellolagomService {
    ...
    @Override
    public Topic<com.hines.james.hellolagom.api.HellolagomEvent> helloEvents() {
        ...
        return TopicProducer.taggedStreamWithOffset(HellolagomEvent.TAG.allTags(), (tag, offset) ->
                ...
                persistentEntityRegistry.eventStream(tag, offset).map(eventAndOffset -> {
                    ...
                    com.hines.james.hellolagom.api.HellolagomEvent eventToPublish;
                    ...
                    if (eventAndOffset.first() instanceof HellolagomEvent.GreetingMessageChanged) {
                        ...
                        eventToPublish = new com.hines.james.hellolagom.api.HellolagomEvent.GreetingMessageChanged(
